...
<div id="dlgAddItem-${containerInstance?.id}" title="Add an item" style="padding: 10px; display: none;" >
	<g:form action="createShipment">
		...
		<table>
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label><warehouse:message code="shipmentItem.container.label" default="Container" /></label></td>                            
				...
				<tr class="prop">
					<td valign="top" class="name"><label><warehouse:message code="shipmentItem.lotNumber.label" default="Lot Number" /></label></td>                            
					<td valign="top" class="value">
