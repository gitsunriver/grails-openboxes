...
<g:set var="entityName"
	value="${message(code: 'dashboard.label', default: 'Dashboard')}" />
				...
				<g:form controller="user" action="doLogin" method="post">
					<div class="dialog">
						...
						<table class="userForm">
							...
							<tr class='prop'>
								<td valign='top' style='text-align: left;' width='20%'><label
									for='warehouse'>Select your warehouse:</label></td>
								<td valign='top' style='text-align: left;' width='80%'><g:select
									name="warehouse.id" from="${org.pih.warehouse.Warehouse.list()}"
									optionKey="id" value="" /></td>
							</tr>
						</table>
					</div>
					<div class="buttons"><span class="button"> <g:submitButton name="login" class="save"
